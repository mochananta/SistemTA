            ...
            <div class="col-lg-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <h4 class="card-title">Total Layanan per Bulan</h4>
                                <canvas id="monthlyChart"></canvas>
                                <p class="mt-3 mb-4 mb-lg-0">Grafik Layanan surat per bulan</p>
                            </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <ul class="graphl-legend-rectangle">
                                            @foreach ($jenisSuratLabels as $index => $label)
                                                <li><span class="bg-info"></span>{{ $label }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                ...
                                <p class="mt-3 mb-4 mb-lg-0">Statistik berdasarkan jenis surat yang diajukan.</p>
                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="progress progress-lg grouped mb-2">
                                            <div class="progress-bar bg-success"
                                                style="width: {{ $countApprovedSurat + $countApprovedKonsultasi }}%"
                                                role="progressbar"></div>
                                            <div class="progress-bar bg-danger"
                                                style="width: {{ $countRejectedSurat + $countRejectedKonsultasi }}%"
                                                role="progressbar"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <ul class="graphl-legend-rectangle">
                                            <li><span class="bg-success"></span>Disetujui
                                                ({{ $countApprovedSurat + $countApprovedKonsultasi }})</li>
                                            <li><span class="bg-danger"></span>Ditolak
                                                ({{ $countRejectedSurat + $countRejectedKonsultasi }})</li>
                                        </ul>
                                    </div>
                                </div>
                                <p class="mb-0 mt-2">Persentase pengajuan surat.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
                <div class="card congratulation-bg text-center">
                    <div class="card-body pb-0">
                        ...
                        <p>Total layanan masuk bulan ini:
                            <span class="font-weight-bold">{{ $monthlyCountsSuratSum + $monthlyCountsKonsultasiSum }}</span>
                            Pengajuan Surat dan Konsultasi.
                        </p>
                        <p class="text-white-50">Status menunggu diproses:
                            <span class="font-weight-bold">{{ $countPendingSurat + $countPendingKonsultasi }}</span>
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <ul class="nav nav-tabs tab-no-active-fill" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active ps-2 pe-2" id="revenue-for-last-month-tab"
                                                ...
                                                aria-controls="revenue-for-last-month" aria-selected="true">Revenue for
                                                last month</a>
                                        </li>
                                        <li class="nav-item">
