    ...
    <section id="pengajuan-surat" class="mt-12 py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 border border-green-200 dark:border-gray-700">
                    <h3 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white flex items-center">
                        <i class="fas fa-file-alt mr-2 text-green-600 dark:text-green-400"></i> Persyaratan Pendaftaran Nikah
                    </h3>
                    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 leading-relaxed">
                        ...
                        <li>Surat dispensasi kawin dari pengadilan (jika usia < 19 tahun)</li>
                        <li>Akta cerai / kematian (jika duda/janda)</li>
                    </ul>
