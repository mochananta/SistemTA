    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow hover:shadow-lg transition duration-300 border border-gray-200 dark:border-gray-700">
                ...
                <a href="{{ route('user.layanan.konsultasi') }}" class="inline-block px-6 py-2 text-sm font-semibold bg-primary-600 text-white rounded-md hover:bg-primary-700 transition">
                    Ajukan Konsultasi
                </a>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow hover:shadow-lg transition duration-300 border border-gray-200 dark:border-gray-700">
                ...
                <a href="{{ route('user.layanan.surat') }}" class="inline-block px-6 py-2 text-sm font-semibold bg-primary-600 text-white rounded-md hover:bg-primary-700 transition">
                    Ajukan Surat
                </a>
            </div>
        </div>
