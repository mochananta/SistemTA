        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div
                    ...
                    <div id="modalPersyaratan"
                        ...
                        <div
                            ...
                            <div class="mb-6">
                                ...
                                <h4 class="mb-3 font-semibold text-lg text-green-600 dark:text-green-400">Persyaratan
                                    Dokumen</h4>
                                <ul class="list-decimal list-inside text-gray-700 dark:text-gray-300 space-y-2">
                    ...
                    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-3 leading-relaxed">
                        ...
                        <li>Status layanan: - Menunggu persetujuan, permohonan menunggu persetujuan kepala kantor/unit
                            kerja terkait - Masih dalam proses, permohonan masih dalam proses verifikasi kepala
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                    <form action="<?php echo e(route('konsultasi.store')); ?>" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="kecamatan" id="kecamatan"
                                ...
                                <?php $__currentLoopData = $kecamatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kecamatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kecamatan->kecamatan); ?>"><?php echo e($kecamatan->kecamatan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div>
                            <label for="rumah_ibadah_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SistemTA\resources\views/user/layanan/form-konsultasi/ibadah.blade.php ENDPATH**/ ?>