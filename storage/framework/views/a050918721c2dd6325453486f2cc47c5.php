    ...
    <section id="pengajuan-surat" class="mt-12 py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl font-extrabold text-green-700 dark:text-green-400">Formulir Pelayanan Pendaftaran
                    Pernikahan </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white flex items-center">
                        <i class="fas fa-file-alt mr-2 text-green-600 dark:text-green-400"></i> Persyaratan Pendaftaran
                        Nikah
                    </h3>
                        ...
                        <div
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-decimal list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-4">
                                    ...
                                    <li>Surat rekomendasi nikah dari KUA setempat, jika catin melangsungkan nikah di luar
                                        kecamatan tempat tinggalnya</li>
                                    <li>Surat keterangan sehat dari fasilitas kesehatan</li>
                                    <li>Persetujuan catin</li>
                                    <li><span class="italic text-yellow-600 dark:text-yellow-400">(Opsional)</span> Izin
                                        tertulis dari orang tua atau wali, bagi catin yang belum mencapai usia 21 tahun</li>
                                    <li><span class="italic text-yellow-600 dark:text-yellow-400">(Opsional)</span> Surat
                                        dispensasi kawin dari Pengadilan, bagi catin yang belum mencapai usia 19 tahun
                                        (dihitung dari tanggal pelaksanaan nikah)</li>
                                    <li><span class="italic text-yellow-600 dark:text-yellow-400">(Opsional)</span> Surat
                                        izin dari atasan atau kesatuan, bagi anggota TNI/POLRI</li>
                                    <li><span class="italic text-yellow-600 dark:text-yellow-400">(Opsional)</span>
                                        Penetapan izin poligami dari Pengadilan Agama, bagi suami yang hendak beristri lebih
                                        dari satu orang</li>
                                    <li><span class="italic text-yellow-600 dark:text-yellow-400">(Opsional)</span> Akta
                                        cerai, bagi duda/janda cerai hidup</li>
                                    <li><span class="italic text-yellow-600 dark:text-yellow-400">(Opsional)</span> Akta
                                        kematian, bagi duda/janda cerai mati</li>
                                </ol>
                            </div>
                            ...
                            <div class="relative">
                                <select id="kua_id" name="kua_id" required
                                    ...
                                    <?php $__currentLoopData = $kuas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kua): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kua->id); ?>"><?php echo e($kua->nama); ?> - <?php echo e($kua->alamat); ?>
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SistemTA\resources\views/user/layanan/form-surat/pendaftaran-pernikahan.blade.php ENDPATH**/ ?>