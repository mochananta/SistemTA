    ...
    <section id="pengajuan-surat" class="mt-12 py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl font-extrabold text-green-700 dark:text-green-400">Formulir Pelayanan Ikrar Wakaf</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                    <form action="<?php echo e(route('pengajuan.store')); ?>" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="jenis_surat" value="Ikrar">
                        <div>
                            ...
                            <div class="relative">
                                <select id="kua_id" name="kua_id" required
                                    ...
                                    <?php $__currentLoopData = $kuas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kua): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kua->id); ?>"><?php echo e($kua->nama); ?> - <?php echo e($kua->alamat); ?></option>
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SistemTA\resources\views/user/layanan/form-surat/ikrar.blade.php ENDPATH**/ ?>