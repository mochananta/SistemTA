    ...
    <section id="pengajuan-surat" class="mt-12 py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 text-sm text-primary-600 dark:text-primary-400">
                ...
                <a href="<?php echo e(route('user.layanan.konsultasi')); ?>" class="font-medium text-gray-800 dark:text-gray-300 hover:text-primary-600">Layanan
                    Konsultasi</a>
                <span class="mx-2 text-gray-400 dark:text-gray-500">/</span>
            ...
            <div class="mb-12 text-center">
                <h2 class="text-3xl font-extrabold text-green-700 dark:text-green-400">Formulir Pelayanan Rekomendasi Nikah
                </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div
                    ...
                    <p class="mt-4 text-sm italic text-gray-500 dark:text-gray-400">
                        * Semua dokumen wajib dibawa dalam bentuk soft file & asli saat verifikasi.
                    </p>
                </div>
                ...
                <div
                    ...
                    <form action="<?php echo e(route('konsultasi.store')); ?>" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="jenis_konsultasi" value="Rekomendasi Pernikahan">
                        <div>
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SistemTA\resources\views/user/layanan/form-konsultasi/rekomendasi-nikah.blade.php ENDPATH**/ ?>