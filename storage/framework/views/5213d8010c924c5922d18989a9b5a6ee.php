            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between px-3 py-2">
                ...
                <div class="d-flex align-items-center gap-2 mx-auto">
                    <a href="#" class="d-flex align-items-center gap-2 text-decoration-none">
                        <img src="<?php echo e(asset('user/kemenag.png')); ?>" alt="Logo Kemenag" class="h-8 w-auto"
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#"
                            ...
                            <span class="nav-profile-name text-dark fw-medium"><?php echo e($displayName); ?></span>
                            <img src="<?php echo e(asset('admin/images/admin.png')); ?>" alt="profile" />
                        </a>
    ...
    <nav class="bottom-navbar shadow-sm bg-white border-top">
        <div class="container">
            <ul class="nav page-navigation justify-content-between">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.surat.view')); ?>"
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.konsultasi.view')); ?>"
                        class="nav-link d-flex flex-column align-items-center text-center">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.ibadah.view')); ?>"
                        class="nav-link d-flex flex-column align-items-center text-center">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.rekap.view')); ?>"
                        class="nav-link d-flex flex-column align-items-center text-center">
...
<?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/admin/partical/navbar.blade.php ENDPATH**/ ?>