        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-10 max-w-5xl mx-auto">
                ...
                <div
                    ...
                    <img src="<?php echo e(asset('user/nanta.jpg')); ?>" alt="Moh. Ananta"
                ...
                <div
                    class="bg-gray-100 dark:bg-gray-800 rounded-2xl shadow-lg p-8 w-80 text-center hover:shadow-xl transition">
                    <img src="<?php echo e(asset('img/foto2.jpg')); ?>" alt="Nama Developer"
                        class="w-32 h-32 mx-auto rounded-full mb-4 shadow object-cover">
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/user/about.blade.php ENDPATH**/ ?>