        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div
                    ...
                    <a href="<?php echo e(url('/form/konsultasi-rekomendasi-nikah')); ?>"
                ...
                <div
                   ...
                   <a href="<?php echo e(url('/form/konsultasi-pendaftaran-pernikahan')); ?>"
                        class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                        Lihat Detail →
                    </a>
                </div>
                ...
                <div
                    ...
                    <a href="<?php echo e(url('/form/konsultasi-wakaf')); ?>"
                        class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                        Lihat Detail →
                    </a>
                </div>
                ...
                <div
                   ...
                   <a href="<?php echo e(url('/form/konsultasi-ibadah')); ?>"
                        class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                        Lihat Detail →
                    </a>
                </div>
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SistemTA\resources\views/user/layanan/konsultasi.blade.php ENDPATH**/ ?>