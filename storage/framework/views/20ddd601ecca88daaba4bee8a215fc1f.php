        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 text-sm text-primary-600 dark:text-primary-400">
                ...
                <a href="/" class="font-medium text-gray-800 dark:text-gray-300 hover:text-primary-600">Layanan
                    Konsultasi</a>
                <span class="mx-2 text-gray-400 dark:text-gray-500">/</span>
                <span class="text-gray-600 dark:text-gray-300">Pelayanan Wakaf</span>
            </div>
            <!-- Title -->
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SistemTA\resources\views/user/layanan/form-konsultasi/wakaf.blade.php ENDPATH**/ ?>