        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="nohp" name="nohp" value="<?php echo e(old('nohp')); ?>" required
                        class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-700"
          ...
          <div class="mb-6">
            ...
            <p class="mt-4 text-sm text-center text-gray-600">
                Sudah punya akun?
                <a href="<?php echo e(route('login')); ?>" class="text-green-600 hover:underline">Masuk sekarang</a>
            </p>
        </form>
...
<?php /**PATH C:\laragon\www\SistemTA\resources\views/auth/register.blade.php ENDPATH**/ ?>