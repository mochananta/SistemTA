...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Kementerian Agama Banyuwangi'); ?></title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" />
    <link rel="stylesheet" href="<?php echo e(asset('user/style.css')); ?>">
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">

<body <?php if(session('kode_layanan')): ?> data-kodelayanan="<?php echo e(session('kode_layanan')); ?>" <?php endif; ?>
    ...
    <!-- Navigation -->
    <?php echo $__env->make('user.partical.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <!-- Footer -->
    <?php echo $__env->make('user.partical.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('user/darkmode.js')); ?>"></script>
    <script src="<?php echo e(asset('user/kodelayanan.js')); ?>"></script>
    <script src="<?php echo e(asset('user/statistik.js')); ?>"></script>
    ...
    <script>
        window.chartData = {
            donutLabels: <?php echo json_encode($labels ?? [], 15, 512) ?>,
            donutSeries: <?php echo json_encode($donutSeries ?? [], 15, 512) ?>,
            lineLabels: <?php echo json_encode($lineLabels ?? [], 15, 512) ?>,
            lineSurat: <?php echo json_encode($lineSurat ?? [], 15, 512) ?>,
            lineKonsultasi: <?php echo json_encode($lineKonsultasi ?? [], 15, 512) ?>,
        };
    </script>
...
<?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/user/landing.blade.php ENDPATH**/ ?>