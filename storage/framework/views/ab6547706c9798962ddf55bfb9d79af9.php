            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div
                    ...
                    <h3 class="text-4xl font-bold text-primary-600 dark:text-primary-400">
                        <?php echo e(number_format($statistikLayanan['Pendaftaran Pernikahan'] ?? 0)); ?>
                ...
                <div
                    class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100 dark:border-gray-700">
                    <h3 class="text-4xl font-bold text-primary-600 dark:text-primary-400">
                        <?php echo e(number_format($statistikLayanan['Wakaf'] ?? 0)); ?>
                ...
                <div
                    class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100 dark:border-gray-700">
                    <h3 class="text-4xl font-bold text-primary-600 dark:text-primary-400">
                        <?php echo e(number_format($statistikLayanan['Rumah Ibadah'] ?? 0)); ?>
                ...
                <div
                    class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100 dark:border-gray-700">
                    <h3 class="text-4xl font-bold text-primary-600 dark:text-primary-400">
                        <?php echo e(number_format($statistikLayanan['Rekomendasi Pernikahan'] ?? 0)); ?>
            ...
            <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg p-6 overflow-x-auto">
                ...
                <table class="min-w-full text-sm text-left text-gray-600 dark:text-gray-300">
                    ...
                    <tbody id="rumahIbadahBody" class="bg-white dark:bg-gray-800">
                        <?php $__empty_1 = true; $__currentLoopData = $rumahIbadah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4"><?php echo e($item->kecamatan ?? '-'); ?></td>
                                <td class="px-6 py-4"><?php echo e($item->kontak ?? '-'); ?></td>
                            </tr>
...
<?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/user/partical/kontenlayanan.blade.php ENDPATH**/ ?>