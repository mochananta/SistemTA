    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <tr>
            <td style="padding: 30px;">
                <h2 style="font-size: 20px; color: #1f2937; margin-bottom: 20px;">Halo <?php echo e($name); ?>,</h2>
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="<?php echo e($url); ?>" style="background-color: #43A047; color: white; font-weight: bold; text-decoration: none; padding: 14px 28px; border-radius: 6px; display: inline-block;">
                        Atur Ulang Password
                    </a>
                </div>
        ...
        <tr>
            <td style="background-color: #f9fafb; text-align: center; padding: 20px; font-size: 12px; color: #6b7280;">
                © <?php echo e(now()->year); ?> Kementerian Agama. All rights reserved.<br>
                Ikuti kami di
...
<?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/emails/reset-password-custom.blade.php ENDPATH**/ ?>