...
<section id="pengajuan-surat" class="mt-12 py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Jenis Pengajuan Surat</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
                ...
                <a href="<?php echo e(url('/form/surat-rekomendasi-nikah')); ?>" class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                    Lihat Detail →
                </a>
            </div>
            <!-- Card 2: Pendaftaran  Nikah-->
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
                <div class="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-lg flex items-center justify-center mb-4">
                ...
                <a href="<?php echo e(url('/form/surat-pendaftaran-pernikahan')); ?>" class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                    Lihat Detail →
                </a>
            </div>

            <!-- Card 3: Izin Kegiatan -->
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
                <div class="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-lg flex items-center justify-center mb-4">
                ...
                <a href="<?php echo e(url('/form/surat-wakaf')); ?>"  class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                    Lihat Detail →
                </a>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
                ...
                <a href="<?php echo e(url('/form/surat-ibadah')); ?>" class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:hover:text-primary-400">
                    Lihat Detail →
                </a>
            </div>
        </div>
...
<?php echo $__env->make('user.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/user/layanan/surat.blade.php ENDPATH**/ ?>