...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('user/auth/style.css')); ?>">
...
<body class="bg-green-50 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
            ...
            <div class="mb-6">
                <div class="flex justify-between mb-1">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-green-600 hover:underline">
                            Lupa password?
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <p class="mt-6 text-sm text-center text-gray-600">Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="text-green-600 hover:underline">Daftar sekarang</a>
        </p>
    </div>

    <script src="https://unpkg.com/feather-icons"></script>
    <script src="<?php echo e(asset('user/auth/eye.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\SistemTA\resources\views/auth/login.blade.php ENDPATH**/ ?>